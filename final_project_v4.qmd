...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     xlab = "Budget", 
     ylab = "Log International Gross",
     main = "Budget vs Log International Gross")
...
```{r, message=FALSE, results='hide'}
lm_mod_decade_code <- lm(intgross_2013 ~ binary * genre + budget_2013*binary + decade_code, data = movie_data)
...
movie_data$log_budget_2013 <- log(movie_data$budget_2013)
movie_data$log_intgross_2013 <- log(movie_data$intgross_2013)
log_lm_model <- lm(log_intgross_2013 ~ binary * genre + log_budget_2013*binary + decade_code, data = movie_data)
