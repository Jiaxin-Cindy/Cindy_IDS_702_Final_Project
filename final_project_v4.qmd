...
log_lm_model <- lm(log_intgross ~ binary * genre + log_budget + decade_code, data = movie_data)
...
mod_reduced <- lm(log_intgross ~ binary + genre + log_budget + decade_code, data = movie_data)
