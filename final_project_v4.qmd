...
movie_data$genre_color <- genre_colors[as.numeric(movie_data$genre)]
...
plot(movie_data$budget_2013, movie_data$intgross_2013, 
     ...
     main = "Budget vs International Gross (Color-Blind Friendly)")

legend("topleft", legend = levels(movie_data$genre), col = genre_colors, pch = 19)
...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     ...
     main = "Log Budget vs Log International Gross (Color-Blind Friendly)")
...
plot(movie_data$budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Budget", 
     ylab = "Log International Gross",
     main = "Budget vs Log International Gross (Color-Blind Friendly)")
...
plot(movie_data$log_budget_2013, movie_data$intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "International Gross",
     main = "Log Budget vs International Gross (Color-Blind Friendly)")
...
movie_data$decade_color <- decade_colors[as.numeric(movie_data$decade_code)]
...
plot(movie_data$budget_2013, movie_data$intgross_2013, 
     ...
     xlab = "Budget", 
     ylab = "International Gross",
     main = "Budget vs International Gross (Grouped by Decade)")

legend("topleft", legend = levels(movie_data$decade_code), col = decade_colors, pch = 19)
...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "Log International Gross",
     main = "Log Budget vs Log International Gross (Grouped by Decade)")
...
plot(movie_data$budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Budget", 
     ylab = "Log International Gross",
     main = "Budget vs Log International Gross (Grouped by Decade)")
...
plot(movie_data$log_budget_2013, movie_data$intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "International Gross",
     main = "Log Budget vs International Gross (Grouped by Decade)")
...
```
```{r}
# Group by binary (pass fail bechdel)
...
movie_data$binary_color <- binary_colors[as.numeric(movie_data$binary)]
...
plot(movie_data$budget_2013, movie_data$intgross_2013, 
     ...
     xlab = "Budget", 
     ylab = "International Gross",
     main = "Budget vs International Gross (Grouped by Binary)")

legend("topleft", legend = levels(movie_data$binary), col = binary_colors, pch = 19)
...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "Log International Gross",
     main = "Log Budget vs Log International Gross (Grouped by Binary)")
...
plot(movie_data$budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Budget", 
     ylab = "Log International Gross",
     main = "Budget vs Log International Gross (Grouped by Binary)")
...
plot(movie_data$log_budget_2013, movie_data$intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "International Gross",
     main = "Log Budget vs International Gross (Grouped by Binary)")
