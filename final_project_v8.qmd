...
# Log Transformed Budget vs Log worldwide Gross Scatter Plot
...
interaction_plot <- ggplot(movie_data, aes(x = binary, y = log_intgross_2013, fill = genre)) +
  geom_boxplot() +
  labs(
    title = "Worldwide Gross by Genre and Passing Test",
    x = "Passing Test",
    y = "Worldwide Gross"
  ) +
  theme_minimal()
...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "Log Worldwide Gross",
     main = "Log Budget vs Log Worldwide Gross (by Decade)")
...
plot(movie_data$log_budget_2013, movie_data$log_intgross_2013, 
     ...
     xlab = "Log Budget", 
     ylab = "Log Worldwide Gross",
     main = "Log Budget vs Log Worldwide Gross (by Bechdel Result)")
