...
After initial data preprocessing, our dataset contains XXXXX rows. Of these XXXX films, 803 of them passed the Bechdel test, while 991 of the films passed the test.

|                             | Action | Comedy | Drama | Family | Horror | Romance | Other |
|---------------------|--------|--------|--------|--------|--------|--------|--------|
| Number of Movies in Dataset | 483    | 498    | 442   | 23     | 100    | 2       | 246   |
...
ResearchQ2ModelWithoutExtreme <- lm(intgross_2013 ~ + binary + genre  + budget_2013 +domgross_2013+  period_code + decade_code  , data = clean_movie_data_no_influential)
