...
ggplot(movie_data, aes(x = binary, y = log_intgross_2013, fill = binary)) +
  ...
  labs(
    ...
    x = "Bechdel Test Result",
    y = "Log of Worldwide Gross Revenue (2013 dollars)",
    fill = "Bechdel Test Result"
  ) +
